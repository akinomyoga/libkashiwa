...
plot \
  ...
  "out/rk/dop853.txt"  u (abs($5)):(yaxis($1,$5)) w lp ps 0.5 title '(DOP853)', \
...
plot \
  "out/rk/rkeuler.txt" u (abs($5)):(yaxis($1,$5)) w lp ps 0.5 lc rgb '#222222' title 'Euler', \
  "out/rk/rkmid.txt"   u (abs($5)):(yaxis($1,$5)) w lp ps 0.5 lc rgb '#884400' title 'midpoint', \
  "out/rk/rkral.txt"   u (abs($5)):(yaxis($1,$5)) w lp ps 0.5 lc rgb '#CCAAAA' title 'Ralston', \
  "out/rk/rkheun.txt"  u (abs($5)):(yaxis($1,$5)) w lp ps 0.5 lc rgb '#880000' title 'Heun', \
  "out/rk/runge3.txt"  u (abs($5)):(yaxis($1,$5)) w lp ps 0.5 lc rgb '#AACCAA' title 'Runge3', \
  "out/rk/rkheun3.txt" u (abs($5)):(yaxis($1,$5)) w lp ps 0.5 lc rgb '#008844' title 'Heun3', \
  "out/rk/rkral3.txt"  u (abs($5)):(yaxis($1,$5)) w lp ps 0.5 lc rgb '#AACCCC' title 'Ralston3', \
  "out/rk/rkk3.txt"    u (abs($5)):(yaxis($1,$5)) w lp ps 0.5 lc rgb '#006600' title 'Kutta3', \
  "out/rk/rkrk4.txt"   u (abs($5)):(yaxis($1,$5)) w lp ps 0.5 lc rgb '#000088' title 'RK4', \
  "out/rk/rkgill.txt"  u (abs($5)):(yaxis($1,$5)) w lp ps 0.5 lc rgb '#6666AA' title 'Gill', \
  "out/rk/rkk38.txt"   u (abs($5)):(yaxis($1,$5)) w lp ps 0.5 lc rgb '#0000FF' title 'Kutta 3/8', \
  "out/rk/b5v3.txt"    u (abs($5)):(yaxis($1,$5)) w lp ps 0.5 lc rgb '#880088' title 'Butcher5v3', \
  "out/rk/b5v2.txt"    u (abs($5)):(yaxis($1,$5)) w lp ps 0.5 lc rgb '#CCAACC' title 'Butcher5v2', \
  "out/rk/b5v1.txt"    u (abs($5)):(yaxis($1,$5)) w lp ps 0.5 lc rgb '#FF00FF' title 'Butcher5v1', \
  "out/rk/hammud6.txt" u (abs($5)):(yaxis($1,$5)) w lp ps 0.5 lc rgb '#CCCC00' title 'Hammud6', \
  "out/rk/shanks7.txt" u (abs($5)):(yaxis($1,$5)) w lp ps 0.5 lc rgb '#88AACC' title 'Shanks7', \
  "out/rk/rkcv7.txt"   u (abs($5)):(yaxis($1,$5)) w lp ps 0.5 lc rgb '#00BBBB' title 'Cooper Verner 7', \
  "out/rk/dop853.txt"  u (abs($5)):(yaxis($1,$5)) w lp ps 0.5 lc rgb '#666666' title '(DOP853)', \
  "out/rk/rkcv8.txt"   u (abs($5)):(yaxis($1,$5)) w lp ps 0.5 lc rgb '#000000' title 'Cooper Verner 8'
